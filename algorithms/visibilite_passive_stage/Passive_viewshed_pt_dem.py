...
class PassiveViewshed_Pt_DEM(QgsProcessingAlgorithm):
    """
    ...
    def name(self):
        ...
        """
        return 'Calcul de la vision active, passive et le raster depth below horizon à partir du point d observation et du MNT '
    ...
    def displayName(self):
        ...
        """
        return self.tr('Vision active,passive et dbh à partir du Pt Obs et MNT')
    ...
    def shortHelpString(self):
        ...
        """
        return self.tr("Calcul de la vision active, passive et le raster depth below horizon à partir du point d observation et du MNT")
