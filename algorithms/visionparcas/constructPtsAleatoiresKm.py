...
class ConstructPointsAleatoiresKm(QgsProcessingAlgorithm):
    """
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(QgsProcessingParameterNumber(
            self.INPUT_COUNT,
            "Densité de points (point/km de perimètre)",
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for current, feature in enumerate(features):
            ...
            if feedback.isCanceled():
                break
            #Périmètre en km
            peri = (feature.geometry().length())/1000
            #Nbr de points souhaitée au total
            count=int(count*peri)
    ...
    def displayName(self):
        ...
        """
        return self.tr("xinterm - Créer points aléatoires sur contour polygone par km/périmètre")
    ...
    def createInstance(self):
        return ConstructPointsAleatoiresKm()
